...
model = BertForSequenceClassification.from_pretrained("E:/sharedtasks capstone/subtask B_edited/mbert_hatespeech")
tokenizer = BertTokenizer.from_pretrained("E:/sharedtasks capstone/subtask B_edited/mbert_hatespeech")
model.eval()
...
# Print the results
test.to_csv("subtaskB_with_predictions_bert.csv", index=False)
